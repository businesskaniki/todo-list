...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _show_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./show.js */ \"./src/show.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _store_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store.js */ \"./src/store.js\");\n/* harmony import */ var _create_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./create.js */ \"./src/create.js\");\n/* harmony import */ var _change_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./change.js */ \"./src/change.js\");\n\n\n\n\n\n\nlet tasksList;\nif (_store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData() === null) {\n  tasksList = [];\n} else {\n  tasksList = _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData();\n}\n\nconst add = (newTask) => {\n  let index;\n  if (_store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData() === null) {\n    index = 1;\n  } else {\n    tasksList = _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData();\n    index = tasksList.length + 1;\n  }\n  const task = new _create_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](newTask, false, index);\n  tasksList.push(task);\n  _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].savetolist(tasksList);\n  _show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].taskdisplay(tasksList);\n};\n\nconst formclear = () => {\n  document.querySelector('#add-new-task').value = '';\n};\n\nconst newtodo = document.querySelector('#add-new-task');\nnewtodo.addEventListener('keyup', (e) => {\n  if (e.keyCode === 13 && newtodo.value !== '') {\n    const newTask = newtodo.value;\n    add(newTask);\n    formclear();\n  }\n});\n\n_show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].taskdisplay(tasksList);\n\nconst btnRefresh = document.querySelector('#btn-refresh');\nbtnRefresh.addEventListener('click', () => {\n  window.location.reload();\n  _show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].reloadPage();\n});\n\nconst clearall = document.querySelector('.btn-clear');\nclearall.addEventListener('click', (e) => {\n  _change_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"].clearcheckedtask(e, tasksList);\n  tasksList = _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData();\n  _show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].updateIndex(tasksList);\n  _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].savetolist(tasksList);\n  tasksList = _store_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getData();\n  _show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].taskdisplay(tasksList);\n});\n\nconst dreload = window.performance.getEntriesByType('navigation')[0].type;\nif (dreload === 'reload') {\n  _show_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].reloadPage();\n}\n\n\n//# sourceURL=webpack://todo-list/./src/index.js?");
